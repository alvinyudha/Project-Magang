                            ...
                            <form action="{{ route('payment.report') }}" method="GET">
                                <div class="form-group d-flex align-items-center">
                                    <input type="text" class="form-control me-2" id="search" name="search"
                                        ...
                                        placeholder="Masukkan ID dan Status Pembayaran ">
                        ...
                        <div class="col-md-4">
                            <form action="{{ route('payment.date') }}" method="GET">
                                <div class="form-group d-flex align-items-center">
                                    ...
                                    <button type="submit" class="btn btn-warning  me-3"><i class="uil-filter"></i></button>
                                    <button type="button" class="btn btn-success"
                                        onclick="window.location.href = '{{ route('payment.export', ['search' => request()->input('search'), 'start_date' => request()->input('start_date')]) }}'">
                                    ...
                                    <div class="modal-dialog modal-dialog-scrollable">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3 row">
                                                    <label for="example-text-input"
                                                        class="col-md-2 col-form-label">Tanggal Bayar</label>
                                                    <div class="col-md-10">
