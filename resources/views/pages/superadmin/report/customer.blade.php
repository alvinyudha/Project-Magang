                        ...
                        <div class="form">
                            <div class="form-group col-md-6 mb-4 d-flex align-items-center">
                                <input type="text" class="form-control me-2" id="search" name="search"
                                    ...
                                    placeholder="Masukkan ID, nama, dan status Pelanggan ">
                                <button type="submit" class="btn btn-primary me-2"><i class="uil uil-search"></i></button>
                                <button type="button" class="btn btn-success"
                                    onclick="window.location.href = '{{ route('customer.export', ['search' => request()->input('search')]) }}'">
